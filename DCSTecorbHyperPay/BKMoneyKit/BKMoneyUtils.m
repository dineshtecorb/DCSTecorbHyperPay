...
+ (UIImage *)cardLogoImageWithShortName:(NSString *)shortName
{
    ...
    if (shortName) {
        ...
        if (localCardLogoImage == nil) {
            cardLogoImage = [self imageNamed:[NSString stringWithFormat:@"BKMoneyKit.bundle/CardLogo/_%@@2x", shortName]];
        }else{
    ...
    if (nil == cardLogoImage) {
        cardLogoImage = [self imageNamed:@"BKMoneyKit.bundle/CardLogo/_default@2x"];
    }
